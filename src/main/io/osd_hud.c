    ...
    if (poiType > 0 && 
        ...
        switch ((osd_unit_e)osdConfig()->units) {
            ...
            case OSD_UNIT_IMPERIAL:
                {
                    if (poiType == 1) {
                        osdFormatCentiNumber(buff, CENTIMETERS_TO_CENTIFEET(poiDistance * 100), FEET_PER_MILE, 0, 4, digits_a);
                    } else {
                        osdFormatCentiNumber(buff, CENTIMETERS_TO_CENTIFEET(poiDistance * 100), FEET_PER_MILE, 0, 3, digits_b);
                    }
                }
                break;
            case OSD_UNIT_GA:
                {
                    if (poiType == 1) {
                        osdFormatCentiNumber(buff, CENTIMETERS_TO_CENTIFEET(poiDistance * 100), FEET_PER_NAUTICALMILE, 0, 4, digits_a);
                    } else {
                        osdFormatCentiNumber(buff, CENTIMETERS_TO_CENTIFEET(poiDistance * 100), FEET_PER_NAUTICALMILE, 0, 3, digits_b);
                    }
                }
                break;
            default:
            ...
            case OSD_UNIT_METRIC:
                {
                    if (poiType == 1) {
                        osdFormatCentiNumber(buff, poiDistance * 100, METERS_PER_KILOMETER, 0, 4, digits_a);
                    } else {
                        osdFormatCentiNumber(buff, poiDistance * 100, METERS_PER_KILOMETER, 0, 3, digits_b);
                    }
                }
                break;
        }
